...
function renderMainPage(req, res, extra, message, bookQuery = req.session.lastSearch, subject) { 
    ...
    bookQuery = bookQuery || 'default search term'; // Substitua 'default search term' pelo termo de pesquisa padrão desejado
    subject = subject || 'default genre'; // Substitua 'default genre' pelo gênero padrão desejado
